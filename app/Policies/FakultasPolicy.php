...
class FakultasPolicy
{
    ...
    {
        return $user->role =='admin' or $user->role =='dosen';// Only allow users with 'admin' role to create Fakultas
    }
    ...
    {
        return false; // Only allow users with 'admin' role to permanently delete Fakultas
    }
}
